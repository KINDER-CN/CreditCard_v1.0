...
public class CreditCardModel {
	...
	private String userName;						//用户名									 card_username
	private String IDcard;							//身份证									 card_idcard
	private int lastThree;							//安全码后三位								 card_lastthree
	...
	public String toString() {
		return "CreditCardModel [id=" + id + ", cardNum=" + cardNum + ", cardType=" + cardType + ", carPassword="
				...
				+ cardPhone + ", userName=" + userName + ", IDcard=" + IDcard + ", lastThree=" + lastThree + "]";
	}
